...
async function newSeason(page) {
    ...
    res = await axios.get(`https://gogoanime.pe/new-season.html?page=${page}`)
...
async function popular(page) {
    ...
    res = await axios.get(`https://gogoanime.pe/popular.html?page=${page}`)
    const body = await res.data;
    const $ = cheerio.load(body)
...
async function search(query) {
    ...
    res = await axios.get(`https://gogoanime.pe//search.html?keyword=${query}`)
    const body = await res.data;
    const $ = cheerio.load(body)
...
async function anime(_anime_name) {
    ...
    res = await axios.get(`https://gogoanime.pe/category/${_anime_name}`)
    const body = await res.data;
    const $ = cheerio.load(body)
